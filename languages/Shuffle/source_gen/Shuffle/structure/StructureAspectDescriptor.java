...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 3:
        return new ConceptDescriptorBuilder("Shuffle.structure.CardCollection").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept", "jetbrains.mps.lang.core.structure.INamedConcept").children(new String[]{"cards"}, new boolean[]{true}).abstract_().create();
      case 4:
      ...
      case 9:
        return new ConceptDescriptorBuilder("Shuffle.structure.Deck").super_("Shuffle.structure.CardCollection").parents("Shuffle.structure.CardCollection", "jetbrains.mps.lang.core.structure.INamedConcept").alias("card set", "").create();
      case 10:
        return new ConceptDescriptorBuilder("Shuffle.structure.DeckReference").super_("Shuffle.structure.CardCollectionReference").parents("Shuffle.structure.CardCollectionReference").alias("Card Set", "").create();
      case 11:
      ...
      case 21:
        return new ConceptDescriptorBuilder("Shuffle.structure.Move").super_("Shuffle.structure.Command").parents("Shuffle.structure.Command").properties("amount").children(new String[]{"pile1", "pile2"}, new boolean[]{false, false}).alias("move", "").create();
      case 22:
      ...
      case 28:
        return new ConceptDescriptorBuilder("Shuffle.structure.PileReference").super_("jetbrains.mps.lang.core.structure.BaseConcept").parents("jetbrains.mps.lang.core.structure.BaseConcept").references("pile").create();
      case 29:
  ...
  private static String[] stringSwitchCases_1htk8d_a0a0b = new String[]{"Shuffle.structure.AndStatement", "Shuffle.structure.Block", "Shuffle.structure.Card", "Shuffle.structure.CardCollection", "Shuffle.structure.CardCollectionReference", "Shuffle.structure.Command", "Shuffle.structure.CommandBlock", "Shuffle.structure.ConditionBlock", "Shuffle.structure.Deal", "Shuffle.structure.Deck", "Shuffle.structure.DeckReference", "Shuffle.structure.ElseIfStatement", "Shuffle.structure.ElseStatement", "Shuffle.structure.EqualToStatement", "Shuffle.structure.ForStatement", "Shuffle.structure.GreaterThanStatement", "Shuffle.structure.Hand", "Shuffle.structure.IfStatement", "Shuffle.structure.LessThanStatement", "Shuffle.structure.LogicalExpression", "Shuffle.structure.Main", "Shuffle.structure.Move", "Shuffle.structure.NotStatement", "Shuffle.structure.Number", "Shuffle.structure.NumberAssignment", "Shuffle.structure.NumberReference", "Shuffle.structure.OrStatement", "Shuffle.structure.Pile", "Shuffle.structure.PileReference", "Shuffle.structure.Player", "Shuffle.structure.SetupBlock", "Shuffle.structure.ShuffleDeck", "Shuffle.structure.Variable", "Shuffle.structure.WhileStatement", "Shuffle.structure.WinConditionBlock"};
}
