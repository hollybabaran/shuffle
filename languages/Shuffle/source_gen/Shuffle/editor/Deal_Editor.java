...
public class Deal_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_1lkok0_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_1lkok0_b0(editorContext, node));
    return editorCell;
  }

  private EditorCell createConstant_1lkok0_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "deal from ");
    editorCell.setCellId("Constant_1lkok0_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }

  private EditorCell createRefNode_1lkok0_b0(EditorContext editorContext, SNode node) {
