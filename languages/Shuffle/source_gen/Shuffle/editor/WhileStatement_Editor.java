...
public class WhileStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_ou8udj_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_ou8udj_b0(editorContext, node));
    ...
    editorCell.addEditorCell(this.createRefNodeList_ou8udj_f0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNode_ou8udj_b0(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNodeList_ou8udj_f0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new WhileStatement_Editor.smodelAttributeListHandler_ou8udj_f0(node, "smodelAttribute", editorContext);
  ...
  private static class smodelAttributeListHandler_ou8udj_f0 extends RefNodeListHandler {
    public smodelAttributeListHandler_ou8udj_f0(SNode ownerNode, String childRole, EditorContext context) {
