...
public class LessThanStatement_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_2ya0u3_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createComponent_2ya0u3_b0(editorContext, node));
    editorCell.addEditorCell(this.createRefNode_2ya0u3_c0(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createComponent_2ya0u3_b0(EditorContext editorContext, SNode node) {
    EditorCell editorCell = editorContext.getCellFactory().createEditorComponentCell(node, "jetbrains.mps.lang.core.editor.alias");
    return editorCell;
  }

  private EditorCell createRefNode_2ya0u3_c0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
