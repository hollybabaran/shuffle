...
public class GreaterThanStatement_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_k7rwy4_a(editorContext, node);
  }

  private EditorCell createCollection_k7rwy4_a(EditorContext editorContext, SNode node) {
  ...
  private EditorCell createRefNode_k7rwy4_a0(EditorContext editorContext, SNode node) {
