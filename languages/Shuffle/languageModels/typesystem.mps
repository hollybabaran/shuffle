...
<model modelUID="r:b57e8ebe-29cf-4b39-86c1-3d625dfafc54(Shuffle.typesystem)">
  ...
  <root type="tpd4.InferenceRule" typeId="tpd4.1174643105530" id="4224678445064256116" nodeInfo="ng">
    <property name="name" nameId="tpck.1169194664001" value="typeof_NumHumanPlayers" />
    <property name="virtualPackage" nameId="tpck.1193676396447" value="Commands" />
    <node role="body" roleId="tpd4.1195213635060" type="tpee.StatementList" typeId="tpee.1068580123136" id="4224678445064256117" nodeInfo="sn">
      <node role="statement" roleId="tpee.1068581517665" type="tpd4.CreateLessThanInequationStatement" typeId="tpd4.1174663118805" id="4224678445064256271" nodeInfo="nn">
        <node role="rightExpression" roleId="tpd4.1174660783414" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="4224678445064256276" nodeInfo="ng">
          <node role="normalType" roleId="tpd4.1185788644032" type="tp3r.Quotation" typeId="tp3r.1196350785113" id="4224678445064256277" nodeInfo="nn">
            <node role="quotedNode" roleId="tp3r.1196350785114" type="tpee.IntegerType" typeId="tpee.1070534370425" id="4224678445064256278" nodeInfo="in" />
          </node>
        </node>
        <node role="leftExpression" roleId="tpd4.1174660783413" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="4224678445064570334" nodeInfo="ng">
          <node role="normalType" roleId="tpd4.1185788644032" type="tpd4.TypeOfExpression" typeId="tpd4.1174657487114" id="4224678445064570330" nodeInfo="nn">
            <node role="term" roleId="tpd4.1174657509053" type="tpee.DotExpression" typeId="tpee.1197027756228" id="4224678445064570529" nodeInfo="nn">
              <node role="operand" roleId="tpee.1197027771414" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="4224678445064570363" nodeInfo="nn">
                <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="4224678445064256119" resolveInfo="numHumanPlayers" />
              </node>
              <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="4224678445064571923" nodeInfo="nn">
                <link role="link" roleId="tp25.1138056516764" targetNodeId="ffsp.4224678445064137271" />
              </node>
            </node>
          </node>
        </node>
    ...
    <node role="applicableNode" roleId="tpd4.1174648101952" type="tpd4.ConceptReference" typeId="tpd4.1174642788531" id="4224678445064256119" nodeInfo="ig">
      <property name="name" nameId="tpck.1169194664001" value="numHumanPlayers" />
      <link role="concept" roleId="tpd4.1174642800329" targetNodeId="ffsp.4224678445064136690" resolveInfo="NumHumanPlayers" />
    </node>
  </root>
</model>
