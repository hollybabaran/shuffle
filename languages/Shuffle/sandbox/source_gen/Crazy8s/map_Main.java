...
public class map_Main {
  ...
  public static void executeGame() throws ShuffleException {
    ...
    CardButton cardbutton = new CardButton("ace", "clubs");
...
CardPile __Pile8980currentCard= new CardPile(gameState.currentPlayer().hand());
for (Card currentCard : __Pile8980currentCard.getArrayList()){
      if(cardPlayed == false){
