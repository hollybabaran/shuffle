...
CardPile __Pile6147currentCard= new CardPile(gameState.currentPlayer().hand());
for (Card currentCard : __Pile6147currentCard.getArrayList()){
...
CardPile __Pile2180card= new CardPile(gameState.currentPlayer().hand().getSelection());
for (Card card : __Pile2180card.getArrayList()){
