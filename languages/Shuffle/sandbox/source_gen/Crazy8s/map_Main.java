...
CardPile __Pile7005currentCard= new CardPile(gameState.currentPlayer().hand());
for (Card currentCard : __Pile7005currentCard.getArrayList()){
...
CardPile __Pile6787card= new CardPile(gameState.currentPlayer().hand().getSelection());
for (Card card : __Pile6787card.getArrayList()){
